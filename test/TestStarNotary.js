...
it('can add the star name and star symbol properly', async() => {
    ...
    let user1 = accounts[1];
    let starId = 6;
    let expectedName = "Universal Star Register Token";
    let expectedSymbol = "USRT";
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let actual = await instance.lookUptokenIdToStarInfo.call(10);

    // 3. Verify if you Star name is the same
    assert.equal(actual, starName);
});